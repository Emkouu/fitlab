  ...
  return (
    <main className="min-h-screen bg-[#fdfafd] flex flex-col items-center justify-center px-5 font-sans">
      ...
      <section className="mt-12 w-full max-w-[300px] border-t border-gray-100 pt-8 text-center">
        ...
        <a
          href="https://maps.google.com/?q=Варна,+ул.+Патриарх+Евтимий+7а,+9000"
          target="_blank"
        ...
        <div className="mt-5 flex items-center justify-center gap-5">
          <a
            href="https://www.facebook.com/profile.php?id=61557049447834"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
          ...
          <a
            href="https://www.instagram.com/fitlabvarna/"
            target="_blank"
            rel="noopener noreferrer"
