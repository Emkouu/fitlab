  ...
  return (
    <main className="mx-auto w-full max-w-[440px] px-5 pb-16 pt-6 font-sans text-[color:var(--brand-ink)] md:max-w-2xl">
      ...
      <section id="payments" className={card}>
        ...
        <p className={p}>
          За всяка резервация се дължи <strong>депозит от {deposit}</strong>.
          Депозитът гарантира мястото ти и се урежда според правилата за отказ
          по-долу. Всички суми са в евро (EUR) и са крайни.
        </p>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <li className={li}>
            <strong>С баланс</strong> — ползваш вече платен депозит, върнат след
            навременна отмяна. Един депозит важи за една резервация.
          </li>
        </ul>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li className={li}>
            При отмяна по-рано от <strong>{cancelHours} часа</strong> преди
            началото на класа депозитът се запазва и се връща като{" "}
            <strong>баланс в профила ти</strong>, готов за следваща резервация.
          </li>
          <li className={li}>
          ...
          <li className={li}>
            При отмяна по-късно от {cancelHours} часа преди класа или при
      ...
      <section id="terms" className={card}>
        ...
        <p className={p}>
          ...
          показват в реално време. За всяка резервация се дължи депозит от{" "}
          {deposit}, който виждаш преди да потвърдиш.
        </p>

        <h3 className={subTitle}>Как се резервира</h3>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li className={li}>
            Влизаш с имейл и еднократен код (без парола), избираш клас и начин на
            плащане на депозита.
          </li>
          <li className={li}>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li className={li}>
            ...
            преди началото на класа — депозитът се запазва (виж „Плащания и
            депозити“).
          </li>
          <li className={li}>
          ...
          <li className={li}>
            Ако ние отменим клас, депозитът ти се възстановява напълно — като
            баланс или по картата, по твой избор.
          </li>
        </ul>
